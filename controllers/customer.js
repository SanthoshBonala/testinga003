...
//@author Mehar Choudhary Meenavilli
...
api.post('/save', (req, res) => {
  ...
  item.firstName = req.body.firstName +"  new"
  item.lastName = req.body.lastName
  item.emailID = req.body.emailID
  item.mobileNumber = req.body.mobileNumber
...
api.post('/save/:id', (req, res) => {
  ...
  item.firstName = req.body.firstName + "  updated"
  item.lastName = req.body.lastName
  item.emailID = req.body.emailID
  item.mobileNumber = req.body.mobileNumber
  item.address = req.body.address
