...
api.post('/save', (req, res) => {
  ...
  item.productName = req.body.name + " --NEW ITEM"
  item.productDescription = req.body.description
  item.productPrice = req.body.price
...
api.post('/save/:id', (req, res) => {
  ...
  item.productName = req.body.name + " --UPDATED ITEM"
  item.productDescription = req.body.description
  item.productPrice = req.body.price
  item.productCategory = req.body.category
