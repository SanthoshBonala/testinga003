// controller for E-commerce project
// Group: 6-01
// Author: Suresh Chandra Peddinti <s533575@nwmissouri.edu>
...
api.get('/findall', (req, res) => {
  ...
  api.get('/findone/:id', (req, res) => {
    ...
    const data = req.app.locals.OrderLineItems.query
    const item = find(data, { orderLine_id: id })
  ...
  api.get('/details/:id', (req, res) => {
    ...
    return res.render('OrderLineItems/details.ejs',
      {
        title: 'details of OrderLineItems',
        layout: 'layout.ejs',
        OrderLineItems: item
      })
  })
